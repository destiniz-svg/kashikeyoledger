...
import { getDashboard, getBills, getVendors, getTaxFiling, getReports, approveBill, rejectBill, API_BASE } from "./api.js";
    ...
    <div style={{ fontFamily: sans, color: T.text, minHeight: "100vh", display: "flex",
      ...
      <main className="flex-1 min-w-0 flex flex-col">
        ...
        <div className="flex-1" style={{ paddingBottom: 64 }} key={session ? "auth" : "anon"}>
          ...
          {!isCore && !["vendors", "filing", "reports"].includes(active) && <Placeholder id={active} />}
        </div>
      </main>
